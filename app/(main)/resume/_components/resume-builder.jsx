...
export default function ResumeBuilder({ initialContent }) {
  ...
  return (
    <div data-color-mode="light" className="space-y-4">
      <div className="animate-fade-in-down flex flex-col md:flex-row justify-between items-center gap-2">
        <h1 className="font-bold gradient-title text-4xl lg:text-6xl">
          Resume Builder
        </h1>
        <div className="space-x-2 md:space-x-4 ">
          ...
          <div className="ml-4 relative inline-block shining-border hover:scale-105">
            <Button
              onClick={generatePDF}
              disabled={isGenerating}
              className="duration-700 cursor-pointer delay-300 hover:scale-105 transition-transform relative z-10"
            >
              {isGenerating ? (
                <>
            ...
            {/* Shining border handled by .shining-border in CSS */}
          </div>
        </div>
      </div>
